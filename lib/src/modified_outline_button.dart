...
class ModifiedOutlineButton extends MaterialButton {
  ...
  factory ModifiedOutlineButton.icon({
    Key key,
    @required VoidCallback onPressed,
    ButtonTextTheme textTheme,
    Color textColor,
...
class _OutlineButtonWithIcon extends ModifiedOutlineButton with MaterialButtonWithIconMixin {
  _OutlineButtonWithIcon({
    Key key,
    @required VoidCallback onPressed,
    ButtonTextTheme textTheme,
